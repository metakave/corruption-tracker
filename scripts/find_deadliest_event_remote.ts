...
async function main() {
    console.log('Searching for REMOTE event...')

    // Search for "Shariatpur" or relevant keywords in Bengali
    ...
    console.log(`Found ${events.length} REMOTE events matching 'Shariatpur'.`)
