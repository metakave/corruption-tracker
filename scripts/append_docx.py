...
# Paths
MD_SOURCE = "/Users/musfiqurtuhin/Documents/WorkSpace/political_violence_tracker/docs/MISSING_SECTIONS.md"
...
def append_docx():
    ...
    # Add a page break before appending new sections
    doc.add_page_break()
