...
export const translations: Record<string, Record<Language, string>> = {
    ...
    'founder_role': { bn: 'প্রতিষ্ঠাতা ও প্রধান প্রকৌশলী', en: 'Founder & Lead Engineer' },
    'sadiq_name': { bn: 'সাদিক মোহাম্মদ আলম', en: 'Sadiq Mohammad Alam' },
    'cofounder_role': { bn: 'সহ-প্রতিষ্ঠাতা ও গবেষক', en: 'Co-Founder & Researcher' },
