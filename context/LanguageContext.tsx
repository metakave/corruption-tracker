...
export const translations: Record<string, Record<Language, string>> = {
    ...
    'dl_subtitle': { bn: 'গবেষক, সাংবাদিক ও নাগরিক সমাজের জন্য যাচাইকৃত দুর্নীতি ডাটাবেজ ডাউনলোড করুন', en: 'Download verified, research-grade anti-corruption and financial crime datasets for journalism and policy analysis' },
    ...
    'dl_sector': { bn: 'খাত বা মন্ত্রণালয়', en: 'Sector / Ministry' },
    'dl_min_severity': { bn: 'নূন্যতম তীব্রতা (১-১০)', en: 'Min. Severity (1-10)' },
    ...
    'dl_ds_events': { bn: 'যাচাইকৃত দুর্নীতির ডাটাবেজ', en: 'Verified Corruption Records' },
    'dl_ds_events_desc': { bn: 'এআই ও গণমাধ্যম দ্বারা যাচাইকৃত দুর্নীতি, অর্থপাচার, আত্মসাৎ ও আইনি অগ্রগতির সম্পূর্ণ তথ্য।', en: 'Clean, structured corruption incidents with BDT amounts, entities, legal statuses, and verified sources.' },
    ...
    'dl_gate_title': { bn: 'ডাটা ডাউনলোড ও পরিচয় যাচাই', en: 'Dataset Download Verification' },
    'dl_gate_desc': { bn: 'যাচাইকৃত গবেষণা ডাটা পাওয়ার জন্য আপনার তথ্য প্রদান করুন। ডাউনলোড লিঙ্কটি সরাসরি আপনার ইমেইলে পৌঁছে দেওয়া হবে।', en: 'Please provide your details to receive verified datasets. A direct download link will be dispatched to your email.' },
    'dl_form_name': { bn: 'আপনার পুরো নাম', en: 'Full Name' },
    'dl_form_whatsapp': { bn: 'হোয়াটসঅ্যাপ নম্বর', en: 'WhatsApp Number' },
    'dl_form_email': { bn: 'ইমেইল ঠিকানা', en: 'Email Address' },
    'dl_form_company': { bn: 'প্রতিষ্ঠান / সংস্থা / বিশ্ববিদ্যালয়', en: 'Company / Organization' },
    'dl_form_designation': { bn: 'পদবী / পেশা', en: 'Designation / Role' },
    'dl_form_submit': { bn: 'ডাউনলোড লিঙ্ক ইমেইলে পাঠান', en: 'Send Download Link to Email' },
    'dl_form_sending': { bn: 'ইমেইল পাঠানো হচ্ছে...', en: 'Sending Link to Email...' },
    'dl_form_success_title': { bn: 'অনুরোধ সফলভাবে সম্পন্ন হয়েছে!', en: 'Download Link Dispatched!' },
    'dl_form_success_desc': { bn: 'ডাউনলোড লিঙ্কটি আপনার ইমেইলে পাঠানো হয়েছে। অনুগ্রহ করে আপনার ইনবক্স চেক করুন।', en: 'The secure download link has been dispatched to your email address. Please check your inbox (and spam folder).' },
    'dl_form_direct_download': { bn: 'সরাসরি ব্যাকআপ ডাউনলোড', en: 'Direct Download (Backup)' },
    'dl_form_close': { bn: 'বন্ধ করুন', en: 'Close' },
