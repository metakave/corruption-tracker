...
import { Radio, BarChart3, Table as TableIcon, Globe, Info, Briefcase } from 'lucide-react'
        ...
        <div className="flex flex-col p-4 md:p-6 gap-6 bg-gray-50 dark:bg-black transition-colors">
            ...
            <div className="bg-gradient-to-r from-blue-900 to-indigo-900 rounded-xl p-6 shadow-md border-l-4 border-yellow-500 relative overflow-hidden shrink-0">
                ...
                <div className="relative z-10">
                    ...
                    <p className={`text-blue-100 text-lg leading-relaxed max-w-4xl ${language === 'bn' ? 'font-bengali' : ''}`}>
                        {t('welcome_desc')}
                    </p>
                </div>
            </div>

            {/* Quick Navigation - Mobile/Tablet Optimized */}
            ...
            <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 min-h-0 pb-20 md:pb-10">
                ...
                <div className="lg:col-span-2 flex flex-col gap-6 min-h-[400px] h-full min-w-0">
                    ...
                    {/* Map Section */}
                    <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 overflow-hidden flex flex-col h-[400px] md:h-full shrink-0 w-full max-w-full">
